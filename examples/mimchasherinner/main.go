...
// 	v, err := recursion.NewVerifier[sw_bls12381.ScalarField, sw_bls12381.G1Affine, sw_bls12381.G2Affine, sw_bls12381.GTEl](api)
// 	if err != nil {
// 		return err
// 	}
...
// 		c.Proof,
// 		c.InnerWitness,
// 		recursion.WithCompleteArithmetic(),
// 		recursion.WithFSInputs(&c.FS),
// 	)
// }
...
// func decomposeG1ForFS(a bls12381.G1Affine) recursion.G1Decomp {
// 	d := hasher.DecomposeG1(a) // [2][2]fr.Element
// 	return recursion.G1Decomp{
// 		XQ: d[0][0].String(),
// 		XM: d[0][1].String(),
// 		YQ: d[1][0].String(),
// 		YM: d[1][1].String(),
...
func main() {
	...
	fmt.Printf("当前使用的最大处理器数 GOMAXPROCS: %d\n", runtime.GOMAXPROCS(0))

	// 3. 查看当前 goroutine 数量
	fmt.Printf("当前 goroutine 数量: %d\n", runtime.NumGoroutine())

	runtime.GOMAXPROCS(1) // 限制总 OS 的线程
	log.Println("设置为单核运行...")
	...
	// circuitVk, err := recursion.ValueOfVerifyingKey[sw_bls12381.ScalarField, sw_bls12381.G1Affine, sw_bls12381.G2Affine](gnarkVK)
	// if err != nil {
	// 	log.Fatalf("value of verifying key: %v", err)
	// }
	// circuitProof, err := recursion.ValueOfProof[sw_bls12381.ScalarField, sw_bls12381.G1Affine, sw_bls12381.G2Affine](gnarkProof)
	// if err != nil {
	// 	log.Fatalf("value of proof: %v", err)
	// }
	// circuitWitness, err := recursion.ValueOfWitness[sw_bls12381.ScalarField](innerPubWit)
	// if err != nil {
	// 	log.Fatalf("value of witness: %v", err)
	// }
	...
	// fsIn.Qc = make([]recursion.G1Decomp, len(vkBLS.Qcp))
	...
	// fsIn.BSB = make([]recursion.G1Decomp, len(prBLS.Bsb22Commitments))
	...
	// 	if !ok {
	// 		log.Fatalf("unexpected public vector type: %T", innerPubWit.Vector())
	// 	}
	...
	// 	Proof:        recursion.PlaceholderProof[sw_bls12381.ScalarField, sw_bls12381.G1Affine, sw_bls12381.G2Affine](pk.ToGnarkConstraintSystem()),
	// 	InnerWitness: recursion.PlaceholderWitness[sw_bls12381.ScalarField](pk.ToGnarkConstraintSystem()),
